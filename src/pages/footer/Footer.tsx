    ...
    <footer className="bg-black text-white py-10 w-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-300">centralfittech@gmail.com</p>
          <p className="text-gray-300 mb-4">(11) 1234-5678</p>
        </div>
        <div className="flex flex-col items-start">
          <h3 className="text-lg font-semibold text-red-500 mb-4">Horário de Funcionamento</h3>
          <p className="text-gray-300">Seg a Sex - 5am 11pm</p>
          <p className="text-gray-300">Sab - 7am 13pm</p>
        </div>
