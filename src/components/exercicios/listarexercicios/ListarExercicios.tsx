...
function ListarExercicios() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-stone-900 text-white flex flex-col items-center py-12 px-6">
      <h1 className="text-3xl font-bold text-white mt-11 border-red-600 pb-2">Exercícios</h1>
      <div className="w-full flex justify-end mb-6">
        {usuario.tipo !== "aluno" && (
          <Link to='/cadastrarexercicio' className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition-transform hover:scale-105 border-2 border-red-700">
